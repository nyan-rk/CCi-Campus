...
//Desc edit
  ...
  $(".row").on("click",".closeTask",function(){
    ...
    $(".row").on("click","#newStackButton",function(){
      $(this).replaceWith("<input type='text' class='newStack' placeholder='"+$(this).parent().attr('text2')+"'></input>");
  });
