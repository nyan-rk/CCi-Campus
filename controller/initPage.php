...
function initPage()
{
    ...
    if (in_array($nomPage, array("index", "profile"))) require "./view/headother.html";
    else require "./view/head.html";
    ...
    if (in_array($nomPage, array("login", "register", "forgot_password"))) require "./view/footeralt.php";
